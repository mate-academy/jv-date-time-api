...
public class JavaDateTimeApi {
    ...
    public static final DateTimeFormatter DATE_WITH_TIME =
            DateTimeFormatter.ofPattern("dd MMMM yyyy k:mm");
    ...
    public Optional<Integer> diffBetweenZones(String firstZone, String secondZone) {
        try {
            int timeFirst = ZonedDateTime.now(ZoneId.of(firstZone)).getHour();
            int timeSecond = ZonedDateTime.now(ZoneId.of(secondZone)).getHour();
            return Optional.of(timeSecond - timeFirst);
    ...
    public Optional<LocalDate> customParseDate(String date) {
        try {
            return Optional.of(
                    LocalDate.parse(date, D_MMM_YYYY));
        } catch (DateTimeException e) {
            return Optional.empty();
        }
    }
