...
public class JavaDateTimeApi {
    ...
    private static final String TIME_ZONE_UKRAINE = "+02:00";
    ...
    public String todayDate(DateTimePart datePart) {
        ...
        switch (datePart) {
            ...
            default:
                throw new DateTimeException("Date value is not correct.");
        }
    }
    ...
    public OffsetDateTime offsetDateTime(LocalDateTime localTime) {
        return OffsetDateTime.of(localTime, ZoneOffset.of(TIME_ZONE_UKRAINE));
    }
