...
public class JavaDateTimeApi {
    ...
    public LocalDateTime getDateInSpecificTimeZone(String dateInString, String zone) {
        return LocalDateTime.ofInstant(Instant.from(ZonedDateTime.parse(dateInString)),
        ZoneId.of(zone).getRules().getOffset(Instant.from(ZonedDateTime.parse(dateInString))));
    }
