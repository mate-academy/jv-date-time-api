...
public class JavaDateTimeApi {
    ...
    public String todayDate(DateTimePart datePart) {
        ...
        switch (datePart) {
            ...
            default: throw new DateTimeException("Wrong query: " + datePart);
        }
    }
    ...
    public OffsetDateTime offsetDateTime(LocalDateTime localTime) {
        return localTime.atOffset(ZoneOffset.of(UKRAINIAN_TIME));
    }
    ...
    public String formatDate(LocalDateTime dateTime) {
        return dateTime.format(DateTimeFormatter.ofPattern(DD_MMMM_YYYY_HH_MM_FORMAT));
    }
}
