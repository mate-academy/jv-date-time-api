...
public class JavaDateTimeApi {
    ...
    public String todayDate(DateTimePart datePart) {
        ...
        switch (datePart) {
            case YEAR:
                return String.valueOf(localNow.getYear());
            case MONTH:
                return localNow.getMonth().toString();
            case DAY:
    ...
    public Optional<LocalDate> getDate(Integer[] dateParams) {
        LocalDate localDate = dateParams.length < 3 || dateParams[1] > 12
                ? null : LocalDate.of(dateParams[0], dateParams[1], dateParams[2]);
    ...
    public String formatDate(LocalDateTime dateTime) {
        boolean isValidFormat = !dateTime.format(FORMAT_DATE).isBlank();
        return isValidFormat ? dateTime.format(FORMAT_DATE)
                : dateTime + " can't be formatted!";
    }
}
