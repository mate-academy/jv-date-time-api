...
public class JavaDateTimeApi {
    ...
    public String beforeOrAfter(LocalDate someDate) {
        ...
        return someDate.isAfter(localDate) ? someDate + " is after " + localDate
                ...
                : someDate.isEqual(localDate) ? someDate + " is today" : "is today";
    }
    ...
    public Optional<Integer> diffBetweenZones(String firstZone, String secondZone) {
        ...
        try {
            firstZoneDateTime = ZonedDateTime.of(localDateTime, ZoneId.of(firstZone));
            secondZoneDateTime = ZonedDateTime.of(localDateTime, ZoneId.of(secondZone));
        } catch (ZoneRulesException ex) {
            return Optional.empty();
        }
        return Optional.of(
                (int) Math.abs(Duration.between(firstZoneDateTime, secondZoneDateTime)
                        .toHours()));
    }
