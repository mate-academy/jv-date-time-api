...
public class JavaDateTimeApi {
    ...
    public String todayDate(DateTimePart datePart) {
        ...
        switch (datePart) {
            ...
            default:
                throw new DateTimeException("Inappropriate input value!");
        }
    }
    ...
    public String beforeOrAfter(LocalDate someDate) {
        ...
        if (someDate.isAfter(currentDate)) {
            return stringBuilder.append(someDate)
                    .append(" is after ").append(currentDate).toString();
        }
        if (someDate.isBefore(currentDate)) {
            return stringBuilder.append(someDate)
                    .append(" is before ").append(currentDate).toString();
        }
        return stringBuilder.append(someDate).append(" is today").toString();
    }
