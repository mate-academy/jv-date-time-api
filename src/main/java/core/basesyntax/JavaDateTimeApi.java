...
public class JavaDateTimeApi {
    ...
    private static final String DISPLACEMENT = "+02:00";
    private static final DateTimeFormatter FORMATTER
            = DateTimeFormatter.ofPattern("dd MMM yyyy", Locale.ENGLISH);
    private static final DateTimeFormatter FORMATTER_ENG
    ...
    public String todayDate(DateTimePart datePart) {
        switch (datePart) {
            ...
            default:
                throw new DateTimeException("Illegal datePart " + datePart);
        }
    }
    ...
    public String beforeOrAfter(LocalDate someDate) {
        return someDate.isAfter(now) ? someDate + " is after " + now : someDate.isBefore(now)
    ...
    public OffsetDateTime offsetDateTime(LocalDateTime localTime) {
        return OffsetDateTime.of(localTime, ZoneOffset.of(DISPLACEMENT));
    }
    ...
    public String formatDate(LocalDateTime dateTime) {
        return dateTime.format(FORMATTER_ENG);
    }
}
