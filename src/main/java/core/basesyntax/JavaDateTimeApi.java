...
public class JavaDateTimeApi {
    ...
    public String todayDate(DateTimePart datePart) {
        ...
        switch (datePart) {
            ...
            default:
                throw new DateTimeException("You have entered wrong datePart");
        }
    }
    ...
    public Optional<LocalDate> getDate(Integer[] dateParams) {
        return dateParams.length == 0 ? Optional.empty() : dateParams[1] > 12 ? Optional.empty() :
    ...
    public String beforeOrAfter(LocalDate someDate) {
        ...
        return someDate.isAfter(today)
                ? String.format("%1$s is after %2$s", someDate.toString(), today.toString()) :
                    someDate.isBefore(today)
                ? String.format("%1$s is before %2$s", someDate.toString(), today.toString()) :
