...
public class JavaDateTimeApi {
    private static final DateTimeFormatter CUSTOM_PARSE_FORMAT =
    ...
    public String todayDate(DateTimePart datePart) {
        switch (datePart) {
            ...
            default:
                throw new DateTimeException("Wrong data time part");
        }
    }
    ...
    public Optional<LocalDate> customParseDate(String date) {
        try {
            return Optional.of(LocalDate.parse(date, CUSTOM_PARSE_FORMAT));
        } catch (DateTimeParseException e) {
            return Optional.empty();
        }
    }
